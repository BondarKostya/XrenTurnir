...
namespace ConsoleApplication1
{
    class Program
    {
        ...
        private static void Listered()
        {
            Sport.SportServiceClient client = new Sport.SportServiceClient(new WSHttpBinding(), new EndpointAddress("http://localhost:8097/Sport"));
            client.Open();
            client.SetData(new WcfLiblary.Data() { Name = "Test24" });
